...
class NfeloGraderModel:
    ...
    def add_se(self):
        ...
        """
        self.df["{0}_se".format(self.model_name)] = (self.model_line + self.result) ** 2
    ...
    def merge_with(self, df):
        ...
        df = pd.merge(
            ...
            self.df[
                [
                    "game_id",
                    "{0}_home_line".format(self.model_name),
                    "{0}_brier".format(self.model_name),
                    "{0}_se".format(self.model_name),
                    "{0}_ats".format(self.model_name),
                    "{0}_ats_be".format(self.model_name),
                    "{0}_su".format(self.model_name),
                ]
            ],
            on=["game_id"],
            how="left",
    ...
    def gen_score_record(self):
        ...
        return {
            ...
            "market_correl": market_correl(self.model_line, self.market_line),
            "brier_adj": adj_brier(
